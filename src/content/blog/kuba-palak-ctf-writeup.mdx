...
```bash title="user@kali:~/Downloads" frame="terminal"
...
```bash title="nc 13.76.181.86 8100" frame="terminal"
...
Using [https://cryptii.com/navajo/text](https://cryptii.com/navajo/text):
